	...
	<div class="txt-box bg-white">
		<div class="conts-area terms-type">
            ...
            <div class="terms-agree-all">
                ...
                <ul class="conts-desc list txt">
                    <li>민감정보 수집이용, 개인정보의 수집 및 이용, 온라인신청 서비스 정책, 고유식별정보 수집 및 이용 항목에 대해 모두 동의합니다.</li>
                    <li>
                    각 사항에 대한 동의 여부를 개별적으로 선택하실 수 있으며, 선택 동의 사항에 대한 동의를 거부하여도 서비스를 이용하실 수 있습니다. </li>
                </ul>
            </div>
